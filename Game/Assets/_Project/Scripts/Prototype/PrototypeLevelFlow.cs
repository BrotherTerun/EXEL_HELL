...
namespace ExcelHell.Prototype
{
    public sealed class PrototypeLevelFlow : MonoBehaviour
    {
        ...
        {
            if (prototype == null) prototype = FindFirstObjectByType<ExcelHellPrototype>();
        ...
        {
            if (labelStyle == null) labelStyle = new GUIStyle(GUI.skin.label) { fontSize = 18, fontStyle = FontStyle.Bold, alignment = TextAnchor.MiddleLeft };
            if (buttonStyle == null) buttonStyle = new GUIStyle(GUI.skin.button) { fontSize = 15, fontStyle = FontStyle.Bold };
        }
    }
}
