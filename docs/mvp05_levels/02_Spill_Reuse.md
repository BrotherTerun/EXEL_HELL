...
| 5 | 74 | **R:Ким blocker** | 34 | 6 | 8 | · | R:Сидоров | · |
| 6 | 66 | · | 42 | 2 | 7 | · | R:Волкова | · |
| 7 | 52 | · | 37 | 4 | 2 | · | · | · |
| 8 | · | · | · | · | · | · | · | · |

`B5` содержит реальный RecordKey `Ким`, не являющийся source-token текущих целей, и блокирует обязательный spill `B3:B7`. Уникальный ключ существует на поле только в этой координате.
